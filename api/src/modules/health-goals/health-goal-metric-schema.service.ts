    ...
    try {
      ...
      await this.prisma.$executeRawUnsafe(`
        CREATE TABLE IF NOT EXISTS "HealthGoalRelation" (
          ...
          CONSTRAINT "HealthGoalRelation_type_check" CHECK ("relationshipType" IN ('SUPPORTS','RELATED_TO','MONITORS')),
          CONSTRAINT "HealthGoalRelation_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "Patient"("id") ON DELETE CASCADE ON UPDATE CASCADE,
          CONSTRAINT "HealthGoalRelation_sourceGoalId_fkey" FOREIGN KEY ("sourceGoalId") REFERENCES "HealthGoal"("id") ON DELETE CASCADE ON UPDATE CASCADE,
          CONSTRAINT "HealthGoalRelation_targetGoalId_fkey" FOREIGN KEY ("targetGoalId") REFERENCES "HealthGoal"("id") ON DELETE CASCADE ON UPDATE CASCADE
        )
      `);
