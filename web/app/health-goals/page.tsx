        ...
        <div className="mx-auto max-w-[1180px] px-4 pb-12 pt-4 sm:px-7 sm:pt-6">
          ...
          {!loading && !error && filteredGoals.length > 0 && <div className="mt-4 grid gap-4 lg:grid-cols-2">
            {filteredGoals.map((goal: any) => {
              ...
              return <article id={`goal-${String(goal.id)}`} key={String(goal.id)} className="group relative scroll-mt-6 overflow-hidden rounded-[26px] border border-[#dce8ec] bg-white p-5 shadow-[0_12px_30px_rgba(11,45,84,.045)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_40px_rgba(11,45,84,.075)] sm:p-6">
