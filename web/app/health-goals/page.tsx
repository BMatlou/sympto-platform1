...
export default function HealthGoalsPage() {
  ...
  async function saveGoal() {
    ...
    if (draft.category === "WEIGHT") {
      ...
      if (draft.weightDirection === "LOSE" && Number.isFinite(weight) && amount >= weight) { toast.error(`A weight-loss goal needs a target below your current weight of ${weight.toFixed(1)} kg.`); return; }
