...
function weightAdvice(weight: number | null, height: number | null, targetWeightInput: number | null, direction: "LOSE" | "GAIN" | "MAINTAIN", targetDate: string) {
  ...
  return { bmi, targetWeight, targetBmi, lowerHealthyWeight, upperHealthyWeight, weekly, underweightNow, targetBelowHealthy, targetAboveHealthy, targetInObesityRange };
}
