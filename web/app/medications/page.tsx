        ...
        <div className="mb-8 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-slate-500">
              Keep track of your current medicines, doses,
              schedules and prescribing information.
            </p>
          </div>
          ...
          {activeMedications.length === 0 ? (
            <div className="rounded-2xl border border-slate-200 bg-white p-10 text-center">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
                ...
                medications recorded in your health profile.
              </p>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-slate-500">
                Always check medication changes with your
                healthcare professional. Sympto does not
