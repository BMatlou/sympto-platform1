      ...
      <main className="min-h-screen bg-slate-50 px-4 py-8 text-[#0b2d54] sm:px-6">
        <div className="mx-auto flex min-h-[80vh] max-w-xl items-center justify-center">
          <section className="w-full rounded-[2rem] bg-white p-8 text-center shadow-[0_20px_60px_rgba(11,45,84,0.10)] ring-1 ring-slate-200 sm:p-12">
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-[#24c1c4]/15 text-[#0b2d54]"><CheckCircle2 className="h-10 w-10" aria-hidden="true" /></div>
    ...
    <main className="min-h-screen bg-slate-50 px-4 py-8 text-[#0b2d54] sm:px-6">
      <div className="mx-auto max-w-2xl">
        ...
        <section className="mt-5 rounded-[2rem] bg-white p-6 shadow-[0_20px_60px_rgba(11,45,84,0.10)] ring-1 ring-slate-200 sm:p-8">
          ...
          <button type="button" onClick={save} disabled={!symptom.trim() || saving} className="mt-7 flex min-h-14 w-full items-center justify-center gap-2 rounded-2xl bg-[#0b2d54] px-5 text-base font-black text-white shadow-lg transition hover:bg-[#071f3a] disabled:cursor-not-allowed disabled:opacity-50 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#24c1c4]/30"><Save className="h-5 w-5" aria-hidden="true" />{saving ? "Saving…" : "Save symptom"}</button>
        </section>
      </div>
    </main>
  );
