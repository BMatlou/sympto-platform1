          ...
          <section className="overflow-hidden rounded-[32px] bg-white shadow-[0_18px_55px_rgba(11,45,84,0.10)] ring-1 ring-slate-200">
            ...
            <div className="p-4 sm:p-7">
              ...
              <div className="grid gap-3 sm:grid-cols-2" aria-label="Choose Smart File sharing scope">
                <button type="button" onClick={() => void createShare("clinical")} disabled={loading} className={`min-h-28 rounded-2xl border px-5 py-4 text-left transition focus:outline-none focus-visible:ring-2 focus-visible:ring-[#24c1c4] ${isClinical ? "border-[#24c1c4] bg-[#24c1c4]/8 ring-1 ring-[#24c1c4]/30" : "border-slate-200 bg-white hover:border-[#24c1c4]/50 hover:bg-[#24c1c4]/5"}`}>
                ...
                <button type="button" onClick={() => void createShare("prescription")} disabled={loading} className={`min-h-28 rounded-2xl border px-5 py-4 text-left transition focus:outline-none focus-visible:ring-2 focus-visible:ring-[#24c1c4] ${kind === "prescription" ? "border-[#24c1c4] bg-[#24c1c4]/8 ring-1 ring-[#24c1c4]/30" : "border-slate-200 bg-white hover:border-[#24c1c4]/50 hover:bg-[#24c1c4]/5"}`}>
              ...
              {!loading && share && !expired && (
                <div className="mt-6 space-y-5">
                  ...
                  <section className="rounded-[28px] border border-slate-200 bg-white p-5 sm:p-6"><div className="flex items-center gap-3"><div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[#0b2d54]/8"><ShieldCheck className="h-5 w-5 text-[#0b2d54]" /></div><div><p className="text-[10px] font-black uppercase tracking-[0.16em] text-slate-400">Privacy &amp; trust</p><h2 className="text-base font-black text-[#0b2d54]">You control what is shared</h2></div></div>
                    {isClinical ? <div className="mt-5 space-y-3"><div className="rounded-2xl bg-emerald-50 p-4 ring-1 ring-emerald-200"><p className="text-sm font-black text-emerald-800">🩺 Clinical Smart File Access: ENABLED</p><p className="mt-1 text-xs font-semibold leading-5 text-emerald-700">Health Passport, conditions, allergies, medications, prescriptions, encounters, vitals, symptoms, tests, imaging and care information.</p></div><div className="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200"><p className="text-sm font-black text-slate-700">💳 Financial / Billing Access: DISABLED</p><p className="mt-1 text-xs font-semibold leading-5 text-slate-500">Invoices, claims, insurance / medical aid, payments and receipts remain locked out.</p></div></div> : <div className="mt-5 space-y-3"><div className="rounded-2xl bg-emerald-50 p-4 ring-1 ring-emerald-200"><p className="text-sm font-black text-emerald-800">💊 Prescription Access: ENABLED</p><p className="mt-1 text-xs font-semibold leading-5 text-emerald-700">The pharmacy receives prescription and medication information needed to dispense your medicines.</p></div><div className="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200"><p className="text-sm font-black text-slate-700">🩺 Clinical Smart File Access: DISABLED</p><p className="mt-1 text-xs font-semibold leading-5 text-slate-500">Your wider clinical history, Health Passport, encounters, tests and diagnoses are not shared.</p></div><div className="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200"><p className="text-sm font-black text-slate-700">💳 Financial / Billing Access: DISABLED</p><p className="mt-1 text-xs font-semibold leading-5 text-slate-500">Invoices, claims, insurance / medical aid, payments and receipts remain locked out.</p></div></div>}
                  </section>
              ...
              {!loading && share && expired && <div className="mt-6 rounded-3xl border border-dashed border-slate-300 bg-slate-50 p-8 text-center"><Clock3 className="mx-auto h-10 w-10 text-slate-300" /><h2 className="mt-4 text-lg font-black text-[#0b2d54]">This share has expired</h2><p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">Generate a fresh one-time QR code and six-digit code for {scopeTitle.toLowerCase()} access.</p><button type="button" onClick={() => { setShare(null); setKind(null); setError(""); }} className="mt-5 inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-[#0b2d54] px-6 py-3 text-sm font-black text-white shadow-sm transition hover:bg-[#071f3a]"><RefreshCw className="h-4 w-4" />Choose sharing type again</button></div>}
            </div>
          </section>
        </div>
      </main>
