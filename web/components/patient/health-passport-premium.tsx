    ...
    <main className="min-h-screen bg-[#f5f8fb] pb-10 text-slate-800">
      <div className="mx-auto max-w-5xl px-4 py-5 sm:px-6 sm:py-7">
        ...
        <div className="mt-5 grid gap-5 md:grid-cols-2">
          <Panel title="Critical & emergency information" icon={<ShieldCheck className="h-5 w-5" />}><div className="grid grid-cols-1 gap-3"><div className="rounded-2xl bg-rose-50 p-4"><p className="text-[10px] font-bold uppercase text-rose-600">Organ donor</p><p className="mt-1 font-bold text-[#0b2d54]">{computed.emergency?.organDonor ? "Yes" : "No"}</p></div></div>{computed.emergency?.emergencyNotes && <div className="mt-3 rounded-2xl bg-amber-50 p-4 text-sm text-amber-900"><span className="font-bold">Emergency notes:</span> {computed.emergency.emergencyNotes}</div>}</Panel>
