    ...
    <ProtectedRoute>
      <main className="min-h-screen bg-[#F7FBFB] text-[#0B2D54]">
        <div className="mx-auto grid max-w-[1500px] grid-cols-1 gap-4 px-3 pb-8 pt-20 sm:px-5 sm:pt-24 lg:grid-cols-[248px_minmax(0,1fr)] lg:gap-5">
          <aside className="hidden lg:sticky lg:top-24 lg:flex lg:h-[calc(100vh-8rem)] lg:min-h-0 lg:flex-col lg:overflow-hidden lg:rounded-[28px] lg:bg-gradient-to-b lg:from-[#0B2D54] lg:to-[#0F5F72] lg:p-3 lg:shadow-[0_16px_48px_rgba(11,45,84,0.16)]">
            <div className="min-h-0 flex-1 overflow-y-scroll overscroll-y-contain pr-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:w-0 [&::-webkit-scrollbar]:h-0">
