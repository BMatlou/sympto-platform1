  ...
  return <ProtectedRoute>
    <main className="min-h-screen bg-[#f4f9fb] text-[#14304d]">
      <div className="mx-auto max-w-[1300px] px-4 py-5 sm:px-6 sm:py-7 lg:px-8">
        ...
        <section className="mt-6 rounded-[27px] border border-[#e0ebef] bg-white p-5 shadow-[0_5px_18px_rgba(11,45,84,0.03)] sm:p-6">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div><p className="text-[10px] font-black uppercase tracking-[0.18em] text-[#71839a]">Current health picture</p><h2 className="mt-1 text-xl font-black tracking-[-.045em] text-[#0b2d54]">Vitals and essentials</h2></div>
          ...
          <HealthVitalsSummary vitals={healthVitals} bmi={bmi} bmiCategory={bmiCategory} />
        </section>
      </div>
    </main>
  </ProtectedRoute>;
