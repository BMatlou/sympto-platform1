...
export default function HealthAccountNav() {
  ...
  const links = [
    ["/appointments", "Appointments", CalendarDays], ["/care-plans", "Care Plans", HeartPulse], ["/health-goals", "Health Goals", HeartPulse], ["/notifications", "Notifications", ShieldCheck], ["/health-passport", "Health Passport", FileHeart], ["/health-records", "Health Records", FileHeart], ["/messages", "Messages", MessageCircle], ["/profile", "Profile", UserRound], ["/family", "Family", Users], ["/settings", "Settings", Settings],
  ] as const;
