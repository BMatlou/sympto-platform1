...
export default function TodayWeightGoal({ goal, fallbackWeight }: Props) {
  ...
  const startingWeight = baselineWeight ?? numberValue(goal?.patient?.weightKg) ?? currentWeight;
